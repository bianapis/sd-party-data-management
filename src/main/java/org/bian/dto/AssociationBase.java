...
public class AssociationBase   {
  ...
  **/
  ...
  /**
   * `status: Provisionally Registered`  general-info: Legal Entity Association Reference (company or individual)    general-info: Legal Entity Association Type (corporate or familial) 
